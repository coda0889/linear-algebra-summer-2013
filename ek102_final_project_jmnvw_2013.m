...
info_box_text = sprintf( [ 'Linear Algebra Learning Box\n\n'...
...
function cb_op00( new_scalar )
    ...
    - DISP_STEP_ARRAY
        - This is tricky, it assumes you are performing your operation on each row
          column by column as it is written fro scalar multiplication. However,
          if you look at the code for Find Determinant, the DISP_STEP_ARRAY is simply
          3 steps. 
...
function cb_op02( ~, ~ )
    ...
    if R == C
        ...
        set( step_history02,...
            'String', 'LU Factorization: Vector of Diagonal of Upper Matrix',...
            'Visible', 'on' ) 
